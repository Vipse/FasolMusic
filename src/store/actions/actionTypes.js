...
export const SET_FREE_INTERVALS = 'SET_FREE_INTERVALS',
...
export const GET_MY_MASTERS = 'GET_MY_MASTERS',  // student
    GET_DEADLINE_PAY = 'GET_DEADLINE_PAY';

export const GET_MASTER_LIST = 'GET_MASTER_LIST'; // coach